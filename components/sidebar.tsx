...
const SidebarItem = (props: SidebarItemProp) => {
  ...
  return (
    <Link
      href={_href}
      className={cn(
        "flex items-center gap-2 rounded px-3 py-2 text-sm text-secondary-foreground transition-colors hover:bg-violet-100 hover:text-black hover:text-primary-foreground",
        {
